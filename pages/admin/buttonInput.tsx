...
const getUrlRadio = () => document.getElementById(`url${props.id}`) as HTMLInputElement;
const getPayloadRadio = () => document.getElementById(`payload${props.id}`,) as HTMLInputElement;
...
const buttonInfoUpdated = () => {
  props.buttonInfos[props.id] = target == "Url" ? {
    title: title,
    url: route
  } : {
    title: title,
...
return (<div>
    ...
    <input type="radio" id={`payload${props.id}`} onChange={payloadRadioClicked}/>
    <br/>
    <br/>
    <label htmlFor="title">Title:   </label>
    <input type="text" placeholder="Title" id="title" name="title" onChange={(event) => setTitle(event.target.value)}/>
    <br/>
    <br/>
    <label htmlFor="target">{target}:   </label>
    <input type="text" placeholder={target} id="target" name="title" onChange={(event) => setRoute(event.target.value)}/>
  </div>)
}
