...
const LanguagePortalChooseContent = () => {
  ...
  const t = useTranslations("languagePortal");
  return (
    <div className="flex-1 rounded-xl bg-white overflow-hidden flex flex-col items-end justify-start pt-[1.25rem] px-[1rem] pb-[1rem] box-border gap-[1rem] max-w-[42.5rem]">
